"""
Fabric Classification App — LOCAL VERSION
Load model from a local file path (no upload needed).
"""
...
DEFAULT_MODEL_PATH = (
    r"C:\Users\yhuang84\Desktop\On_Going_Projects\Sorting2_Sequence"
    r"\For Paper\Training_result\Paper1_finetune"
    r"\run_20260207_124124_fine_tune_cv\models\ConvNeXt-Small_fold1_best.pth"
)
...
def load_model_from_path(model_path: str) -> nn.Module:
...
# ==============================================================================
st.set_page_config(
    page_title="Fabric Classifier (Local)",
    page_icon="🧵",
    layout="wide",
...
with st.sidebar:
    ...
    model_path_input = st.text_input(
        ...
        help="Absolute path to the ConvNeXt-Small_fold1_best.pth file.",
    )
